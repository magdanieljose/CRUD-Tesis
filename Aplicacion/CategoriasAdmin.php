    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            <div  class="row">
                <div class="col-lg-12">
                    <h1>
                        <font color="black" face="Comic Sans MS,arial">Categoria de medicamentos</font>
                    </h1>
...
<script>
    ...
    category.addEventListener('change', () => {
        if(category.value === 0) {
            window.location = `/CategoriasAdmin.php`;
        } else {
            window.location = `/CategoriasAdmin.php?id=${category.value}`;
        }
    });
</script>
</body>
