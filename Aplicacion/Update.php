      ...
      <li><a href="Contactos.html">CONTACTOS</a></li>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1><font color="black" face="Comic Sans MS,arial">Actualización de Medicamentos</h1>
                        <span>
...
<tr>
    ...
    <a href="process.php?delete=<?php echo $row['ID_Producto']; ?>"
             class ="btn btn-danger" onclick="mensaje()">Eliminar</a>
             </td>
...
<?php }  ?>    
  ...
  position: 'center',
  type: 'success',
  title: 'El medicamento fue eliminado exitosamente',
