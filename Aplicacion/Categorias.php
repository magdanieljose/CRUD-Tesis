    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <div id="lateralbuttons">
                ...
                <li>
                   <a href="Lista.php">
                        <font color="white" size="3" face="Comic Sans MS,arial,verdana">Lista de Medicamentos</font>
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            <div  class="row">
                <div class="col-lg-12">
                    <h1>
                        <font color="black" face="Comic Sans MS,arial">Categoria de medicamentos>
                    </h1>

                    <div>
                        <select class="form-control" id="categorias" value ="">
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php 
                                ...
                                if ($idcategoria) {
                                    $result = $mysqli->query("SELECT * FROM  medicamentos WHERE id_categoria = '$idcategoria'")or die($mysqli->error);
                                } else {
                                    $result = $mysqli->query("SELECT * FROM  medicamentos");
                                }
                            ?>         
                            <tbody> 
...
<script>
    ...
    category.addEventListener('change', () => {
        if(category.value === 0) {
            ...
            window.location = `/Categorias.php?id=${category.value}`;
        }
    });
</script>
</body>
