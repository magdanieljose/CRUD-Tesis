...
<div id="categories"> 
  ...
  Puesto <input  type="text" name="id_categoria" value="" placeholder=""> 
  Nombre de la Categoría<input type="text" name="Tipo" value="" placeholder="">
  <button onclick= "alertcategoria()" type="submit" name="save" class="btn btn-primary">Agregar</button>
...
<div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  position: 'center',
  type: 'success',
  title: 'El medicamento fue Agregado exitosamente',
